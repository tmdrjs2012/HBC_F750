    ...
    flexButtonCallback(this, &MainScreenViewBase::flexButtonCallbackHandler)
{
    ...
    textArea1.setXY(103, 142);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    textArea1.setLinespacing(0);
    Unicode::snprintf(textArea1Buffer, TEXTAREA1_SIZE, "%s", touchgfx::TypedText(T_SINGLEUSEID36).getText());
    textArea1.setWildcard(textArea1Buffer);
    textArea1.resizeToCurrentText();
    textArea1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID5));

    textArea1_1.setXY(34, 100);
    ...
    ArmSignText.setXY(57, 100);
    ArmSignText.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    ArmSignText.setLinespacing(0);
    ArmSignText.setTypedText(touchgfx::TypedText(T_SINGLEUSEID33));

    ArmSignText1.setXY(198, 100);
    ArmSignText1.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    ArmSignText1.setLinespacing(0);
    ArmSignText1.setTypedText(touchgfx::TypedText(T_SINGLEUSEID34));

    BackSignText.setXY(126, 142);
    BackSignText.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    BackSignText.setLinespacing(0);
    BackSignText.setTypedText(touchgfx::TypedText(T_SINGLEUSEID35));

    LegSignText.setXY(126, 216);
    LegSignText.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    LegSignText.setLinespacing(0);
    LegSignText.setTypedText(touchgfx::TypedText(T_SINGLEUSEID37));

    RollerSignText.setXY(126, 58);
    RollerSignText.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    RollerSignText.setLinespacing(0);
    RollerSignText.setTypedText(touchgfx::TypedText(T_SINGLEUSEID39));

    //HeartBeat.setPosition(428, 4, 37, 38);
    //HeartBeat.setCenter(20, 20);
    //HeartBeat.setRadius(10);
    //HeartBeat.setLineWidth(0);
    //HeartBeat.setArc(0, 360);
    //HeartBeatPainter.setColor(touchgfx::Color::getColorFromRGB(36, 237, 5));
    //HeartBeat.setPainter(HeartBeatPainter);

    CtoFToggleBtn.setXY(393, 193);
    CtoFToggleBtn.setBitmaps(touchgfx::Bitmap(BITMAP_BLUE_BUTTONS_ROUND_EDGE_ICON_BUTTON_ID), touchgfx::Bitmap(BITMAP_BLUE_BUTTONS_ROUND_EDGE_ICON_BUTTON_PRESSED_ID));
    CtoFToggleBtn.setLabelText(touchgfx::TypedText(T_SINGLEUSEID40));
    CtoFToggleBtn.setLabelColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    CtoFToggleBtn.setLabelColorPressed(touchgfx::Color::getColorFromRGB(255, 255, 255));
    CtoFToggleBtn.setAction(buttonCallback);
...
void MainScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    else if (&src == &CtoFToggleBtn)
    {
        //Interaction14
        //When CtoFToggleBtn clicked call virtual function

        //Call CtoFToggleBtnClicked
    	HAL_NVIC_DisableIRQ(USART6_IRQn);
		CtoFToggleBtnClicked();
		HAL_NVIC_EnableIRQ(USART6_IRQn);
    }
}
